...
const ScheduleRules = {
  ...
  calculateAvailableHours(scheduleData, date) {
    ...
    const blockingEvent = dayEvents.find(e => this.TYPE_CONFIG[e.type]?.isBlocking);
    ...
    const subtractiveEvents = dayEvents.filter(e => this.TYPE_CONFIG[e.type]?.isSubtractive);
