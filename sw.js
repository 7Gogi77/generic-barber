...
// Background sync for bookings (when online again)
...
async function syncPendingBookings() {
  ...
  // Implementation depends on your booking storage strategy
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    body: data.body || 'Imate nov termin!',
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'Barber Shop', options)
  );
});
